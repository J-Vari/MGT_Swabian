...
questionnaire <- read_delim(here("raw data", "data_exp_questionnaire-ry6q-31.csv"), col_names = TRUE, delim = ",")
...
pp_bckgr%>%
  mutate (education_profession1_sum = case_when
          (education_profession1 == "Berufsfachschulabschluss" ~ "low",
            ...
            education_profession1 == "andere" ~ "middle",
...
pp_lang_pop%>%
  select(`Participant Public ID`, other_languages, own_dialect, lang.variety, everything())->pp_lang_pop
