...
lmer (Response ~ Lang.Variety_Audio*own_dialect + Statement_no + Speaker + (Lang.Variety_Audio|bilendi_id) +  (1|Audio_Track), data = outgroup_chari,  REML = TRUE, lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5))) -> model1_lang.var
...
lmer (Response ~ Lang.Variety_Audio*lang.exposure + Statement_no + Speaker + (Lang.Variety_Audio|bilendi_id) +  (1|Audio_Track), data = outgroup_chari,  REML = TRUE, lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5))) -> model2_lang.var
...
origin_authen_all%>%
  ...
  summarise(n_distinct(bilendi_id))->audio_non_st_identity
